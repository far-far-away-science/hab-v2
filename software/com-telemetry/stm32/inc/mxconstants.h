...
#define SIGNAL_TIMER                     TIM3
#define SIGNAL_TIMER_CLK_ENABLE          __HAL_RCC_TIM3_CLK_ENABLE
#define SIGNAL_TIMER_CHANNEL_GPIO_PORT() __HAL_RCC_GPIOA_CLK_ENABLE();__HAL_RCC_GPIOB_CLK_ENABLE()
#define SIGNAL_TIMER_CHANNEL_RED         TIM_CHANNEL_2
#define SIGNAL_GPIO_AF_CHANNEL_RED       GPIO_AF2_TIM3
#define SIGNAL_GPIO_PIN_RED              GPIO_PIN_7
#define SIGNAL_GPIO_CHANNEL_RED          GPIOA
#define SIGNAL_TIMER_CHANNEL_GREEN       TIM_CHANNEL_3
#define SIGNAL_GPIO_AF_CHANNEL_GREEN     GPIO_AF2_TIM3
#define SIGNAL_GPIO_PIN_GREEN            GPIO_PIN_0
#define SIGNAL_GPIO_CHANNEL_GREEN        GPIOB
#define SIGNAL_TIMER_CHANNEL_BLUE        TIM_CHANNEL_4
