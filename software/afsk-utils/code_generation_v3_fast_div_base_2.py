...
class Generator:
    ...
    def formatBestFastDivision(self, fastDivisionAlias):
        ...
        return '((((uint32_t) value) + ' + str(precisionSummand) + ') >> ' + str(firstDivisorPowerOfTwo) + ')'
...
#define PRECISION_CONVERTER_QUANT_IDX(value) ''' + self.formatBestFastDivision('CONST_PRECISION_QUANT_DIVISOR_F1200') + '''
...
#define PRECISION_CONVERTER_TRIG_PARAM_F2200(value) ''' + self.formatBestFastDivision('CONST_PRECISION_TRIG_PARAM_DIVISOR_F1200') + '''
